...
const questions = [
  ...
  `달리기에서 이기면 ___________.``나는 ___________으로 인정받고 싶다.`,
...
const answers = [
  ...
  // last part
  { one: "내가 해야할 일을 먼저 하고 논다.", two: "내가 할 수 있는 일이면 먼저 재미있게 놀고 난 후 해도 괜찮다." },
  { one: "수업 계획에 따라 차근차근 가르쳐 주시는", two: "그때그때마다 우리가 좋아하는 것에 맞춰 수업 내용을 바꿔 가르치시는" },
