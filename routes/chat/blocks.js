...
const answers = [
  // first part
  { left: "여러 친구들과 많이", right: "몇 명의 친구와 깊이" },
  { left: "새로운 친구들을 만나는 것이 신난다.", right: "처음 보는 친구들과 앞으로 어떻게 지낼까 걱정이다." },
  { left: "내가 먼저", right: "다른 친구가 나에게" },
  { left: "다른 사람에게 이야기하는", right: "내 마음 속에 간직하는" },
  { left: "친구들과 함께 하는", right: "나 혼자 재미있게 하는" },
  { left: "많은 친구들에게", right: "친한 친구들에게" },
  { left: "친구들과 함께", right: "나 혼자" },
  { left: "말로 표현하는 것이", right: "글로 표현하는 것이" },
  { left: "활발하다고", right: "얌전하다고" },
  // second part
  { left: "내가 직접 보고 들은 것", right: "내가 상상한 것" },
  { left: "실제로 있었던 사람이나 사실에 대한 책", right: "상상으로 지어낸 이야기" },
  { left: "하던 일을 잘 못한다.", right: "도전하고 싶은 마음이 생긴다." },
  { left: "배웠던 대로 하는 것이 편하다.", right: "새로운 방법을 생각해서 해볼 때 더 재미있다." },
  { left: "그려진 그림에 색칠하기", right: "이야기 지어내기" },
  { left: "현재에 최선을 다하는 것", right: "미래에 대한 꿈을 갖는 것" },
  { left: "선생님이 가르쳐주신 방법", right: "나 스스로 만든 나만의 방법" },
  { left: "좋아하는 책은 읽은 것이라도 또 읽는다.", right: "새로운 다른 책을 읽는 것이 좋다." },
  { left: "부지런하고 성실하다", right: "기발하고 엉뚱하다" },
  // third part
  { left: "불공평한 것", right: "다른 사람의 마음에 상처를 주는 것" },
  { left: "공부 잘하는/실력있는", right: "사람들 사이에서 인기가 좋은" },
  { left: "다음번에는 이기도록 계획을 짠다.", right: "'다음에 이기면 되지'하면서 친구들의 기분을 좋게 해준다." },
  { left: "지적해주는 편이다.", right: "지적하면 친구가 어떻게 생각할까 걱정돼서 말하지 않는 편이다." },
  { left: "공평한", right: "친절한" },
  { left: "기분이 아주 좋다.", right: "기분은 좋지만 진 사람은 기분이 어떨까 생각한다." },
  { left: "똑똑한 사람", right: "따뜻한 사람" },
  { left: "벌을 받아야 한다", right: "도둑질을 하지 않도록 도움을 받아야 한다" },
  { left: "규칙대로 정확하게", right: "상황에 따라 그 사람의 사정을 고려해서" },
  // last part
  { left: "내가 해야할 일을 먼저 하고 논다.", right: "내가 할 수 있는 일이면 먼저 놀고 난 후 해도 괜찮다." },
  { left: "수업 계획에 따라 차근차근 가르쳐 주시는", right: "그때그때마다 우리가 좋아하는 것에 맞춰 바꿔 가르치시는" },
  { left: "정리정돈 된 깨끗한", right: "내 마음대로 흩어놓을 수 있는" },
  { left: "하기 쉽게 잘 짜여진 숙제", right: "새로운 방법으로 하는 숙제" },
  { left: "어디로 갈 지 미리 생각하고 탄다.", right: "그냥 달리고 나서 어디로 갈지 생각한다." },
  { left: "잘 챙기는 편이다.", right: "잘 잊어먹는 편이다." },
  { left: "무엇을 공부해야할지 가르쳐 주시는", right: "우리가 스스로 공부할 것을 선택하도록 맡기시는" },
  { left: "절대로 바뀌어서는 안된다.", right: "경우에 따라 바뀔 수 있다." },
  { left: "계획적으로 해내는", right: "그때그때 해내는" },
];
...
module.exports = { questions, answers, breakMsg, blockIds, startUtterances };
